...
const ApikeyPrompt = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 flex items-center justify-center p-4">
      ...
      <Plus className="h-10 w-10 mt-7 text-gray-400" />
      
      <div className="relative bg-black p-4 rounded-full border border-gray-800">
        <img 
          src="/Script Dev-Circle.png" 
          alt="Script Dev" 
        ...
        />
          ...
          <p className="text-gray-400 text-sm max-w-md mx-auto">
            Enter your API key to unlock the power of artificial intelligence.
            Your gateway to advanced language processing starts here.
          </p>
        </CardHeader>
